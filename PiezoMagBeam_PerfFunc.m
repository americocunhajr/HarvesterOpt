% -----------------------------------------------------------------
%  PiezoMagBeam_PerfFunc.m
% ----------------------------------------------------------------- 
%  This function defines the performance function for the
...
% -----------------------------------------------------------------
function [S,power,K01] = PiezoMagBeam_PerfFunc(phys_param,...
                                              tspan,IC,...
                                              cmin,cmax,Nc,tol01,...
                                              OSflag,Hpenalty,...
                                              p1_min,p1_max,...
...
[time,y] = ode45(@(t,y)PiezoMagBeam_RHS(t,y,phys_param),tspan,IC);
